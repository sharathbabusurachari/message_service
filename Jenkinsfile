    ...
    stages {
        stage('Build') {
            steps {
                ...
                checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[url: 'https://github.com/sharathbabusurachari/message_service.git']])
        ...
        stage('Deploy') {
            steps {
                ...
                script {
                        ...
                        sh "nohup java -jar $WORKSPACE/target/message-0.0.1-SNAPSHOT.jar &"
                        }
                }
